...
## Summary
**Apparatus Vivi. Living machine. The TARDIS. Whatever you wish to call it, it grows, learns, with you. It will learn things from you, so make sure to behave yourself around it, or else it might learn something you wish it wouldn't have learnt. Remember, it is alive, and it will make choices of its own, you are not the one in full control.**
...
- [Lake](https://en.pronouns.page/@lakehascake)
...
### Wiki Curators:
- [Echo](https://github.com/EchoDidAThing1048)
